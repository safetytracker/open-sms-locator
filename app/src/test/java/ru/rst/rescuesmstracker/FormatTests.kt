...
class FormatTests {
    ...
    fun negativeLatitude() {
        ...
        Assert.assertEquals("google.com/maps?q=-25.22222,025.22222", RSTPreferences.CoordsFormat.FORMAT_GOOGLE_MAPS.format(location))
    ...
    fun negativeLongitude() {
        ...
        Assert.assertEquals("google.com/maps?q=51.50986,-0.11809", RSTPreferences.CoordsFormat.FORMAT_GOOGLE_MAPS.format(location))
    ...
    fun integerCoords() {
        ...
        Assert.assertEquals("google.com/maps?q=12.00000,034.00000", RSTPreferences.CoordsFormat.FORMAT_GOOGLE_MAPS.format(location))
