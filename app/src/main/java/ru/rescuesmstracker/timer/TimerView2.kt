...
interface TimerView2 {

    fun showEnabled()

    fun showDisabled()

    fun onGotData(status: RSTTimerView.State, lastSmsSentTimestamp: Long, progress: Float)
    ...
    fun forceSmsSendingStatusUpdated(status: Sms.Status)
}